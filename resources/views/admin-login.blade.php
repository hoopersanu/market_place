...
<html>
    ...
    <form class="form-horizontal  action" action="{{url('/admin-login-validate')}}" method="POST">
        @csrf
    <div class="form-group">
        <label class="control-label" for="email">Email</label>
        <div class="col-sm-6">
            <input type="text" class="form-control input-color" id="email" placeholder="Enter email" name="email">
